/*
  ...
  - The values [RUB,BYN] on the enum `Currency` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "Currency_new" AS ENUM ('UZS', 'USD', 'UAH', 'RUR', 'KZT', 'KGS', 'GEL', 'EUR', 'BYR', 'AZN');
