...
export type GetSuggestKeywordsData = {
  body?: never;
  path?: never;
  query: {
    text: string;
  };
  url: '/suggests/keywords';
};

export type GetSuggestKeywordsResponses = {
  /**
   * Suggestions
   */
  200: HhSuggest;
...
export type GetSuggestKeywordsResponse =
  GetSuggestKeywordsResponses[keyof GetSuggestKeywordsResponses];
